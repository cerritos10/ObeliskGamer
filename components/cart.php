                ...
                <tbody>
                  <tr>
                    ...
                    <td class="product-name">
                      <h2 class="h5 text-black">Rizer Viper</h2>
                    </td>
                    <td>$49.00</td>
                    <td>
                      <div class="input-group mb-1 centrado" style="max-width: 120px;">
                        ...
                        <input type="text" class="form-control text-center cantidad" value="1" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1">
